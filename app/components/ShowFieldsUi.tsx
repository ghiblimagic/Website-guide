    ...
    <div className="flex items-center gap-2 flex-wrap mb-6">
      ...
      {Object.entries(visibleFields).map(([field, visible]) => (
        <button
          ...
          className={`inline-flex items-center gap-1.5 py-1.5 px-3 rounded-2xl font-semibold transition-all text-sm   border-2 border-blue-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 ${
            visible
